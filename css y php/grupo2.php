  ...
  <table width="1109" height="52" border="1" align="center">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><a href="bimestre2.php?grado=<?php echo $_GET['grado'] ?>&bimestre=1&grupo=<?php echo $_GET['grupo'] ?>&matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ASIG</a></td>
        <td><a href="bimestre2.php?grado=<?php echo $_GET['grado'] ?>&bimestre=2&grupo=<?php echo $_GET['grupo'] ?>&matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ASIG</a></td>
        <td><a href="bimestre2.php?grado=<?php echo $_GET['grado'] ?>&bimestre=3&grupo=<?php echo $_GET['grupo'] ?>&matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ASIG</a></td>
        <td><a href="bimestre2.php?grado=<?php echo $_GET['grado'] ?>&bimestre=4&grupo=<?php echo $_GET['grupo'] ?>&matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ASIG</a></td>
        <td><a href="bimestre2.php?grado=<?php echo $_GET['grado'] ?>&bimestre=5&grupo=<?php echo $_GET['grupo'] ?>&matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ASIG</a></td>
      </tr>
      <?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
  </table>
  <br />
<?php echo $totalRows_Recordset1 ?> Registros Total </div>
<div id="apDiv4"><a href="segundo.php"><img src="../img/regresar.png" width="59" height="54" /></a></div>
<div id="apDiv5">ASIGNAR CALIFICACIONES A LOS ALUMNOS DE SEGUNDO AÑO</div>
<div  class="cabezal">
