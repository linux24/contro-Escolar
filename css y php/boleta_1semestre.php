...
$sql1 = "SELECT * FROM proyecto.year1_bim1 WHERE matricula_alumno = ".$matricula_alumno." and bimestre = ".$bimestre."";
$resultado1 = mysql_query($sql1,$idc) or die(mysql_error());
$filas1 = mysql_fetch_assoc($resultado1);
$a=$filas1['esp'];
$b=$filas1['matematicas'];
$c=$filas1['biologia'];
$d=$filas1['geografia'];
$e=$filas1['educacion_fisica'];
$f=$filas1['tecnologia'];
$g=$filas1['artes'];
$h=$filas1['ingles'];
...
$sql2 = "SELECT * FROM proyecto.year1_bim1 WHERE matricula_alumno = ".$matricula_alumno." and bimestre = ".$bimestre2."";
$resultado2 = mysql_query($sql2,$idc) or die(mysql_error());
$filas2 = mysql_fetch_assoc($resultado2);
$a2=$filas2['esp'];
$b2=$filas2['matematicas'];
$c2=$filas2['biologia'];
$d2=$filas2['geografia'];
$e2=$filas2['educacion_fisica'];
$f2=$filas2['tecnologia'];
$g2=$filas2['artes'];
$h2=$filas2['ingles'];
...
$sql3 = "SELECT * FROM proyecto.year1_bim1 WHERE matricula_alumno = ".$matricula_alumno." and bimestre = ".$bimestre3."";
$resultado3 = mysql_query($sql3,$idc) or die(mysql_error());
$filas3 = mysql_fetch_assoc($resultado3);
$a3=$filas3['esp'];
$b3=$filas3['matematicas'];
$c3=$filas3['biologia'];
$d3=$filas3['geografia'];
$e3=$filas3['educacion_fisica'];
$f3=$filas3['tecnologia'];
$g3=$filas3['artes'];
$h3=$filas3['ingles'];
...
$sql4 = "SELECT * FROM proyecto.year1_bim1 WHERE matricula_alumno = ".$matricula_alumno." and bimestre = ".$bimestre4."";
$resultado4 = mysql_query($sql4,$idc) or die(mysql_error());
$filas4 = mysql_fetch_assoc($resultado4);
$a4=$filas4['esp'];
$b4=$filas4['matematicas'];
$c4=$filas4['biologia'];
$d4=$filas4['geografia'];
$e4=$filas4['educacion_fisica'];
$f4=$filas4['tecnologia'];
$g4=$filas4['artes'];
$h4=$filas4['ingles'];
...
$sql5 = "SELECT * FROM proyecto.year1_bim1 WHERE matricula_alumno = ".$matricula_alumno." and bimestre = ".$bimestre5."";
$resultado5 = mysql_query($sql5,$idc) or die(mysql_error());
$filas5 = mysql_fetch_assoc($resultado5);
$a5=$filas5['esp'];
$b5=$filas5['matematicas'];
$c5=$filas5['biologia'];
$d5=$filas5['geografia'];
$e5=$filas5['educacion_fisica'];
$f5=$filas5['tecnologia'];
$g5=$filas5['artes'];
$h5=$filas5['ingles'];
...
<div id="apDiv4">1er GRADO DE EDUCACIÓN SECUNDARIA</div>
...
<div id="apDiv28"><?php echo $filas1['esp'];?>
</div>
<div id="apDiv29"><?php echo $filas1['ingles'];?></div>
<div id="apDiv30"><?php echo $filas1['matematicas'];?></div>
<div id="apDiv31"><?php echo $filas1['biologia'];?></div>
<div id="apDiv32"><?php echo $filas1['geografia'];?></div>
<div id="apDiv33"><?php echo $promedio;?></div>
<div id="apDiv34"><?php echo $filas1['educacion_fisica'];?></div>
<div id="apDiv35"><?php echo $filas1['tecnologia'];?></div>
<div id="apDiv36"><?php echo $filas1['artes'];?></div>
<div id="apDiv37"><?php echo $filas2['esp'];?></div>
<div id="apDiv38"><?php echo $filas2['ingles'];?></div>
<div id="apDiv39"><?php echo $filas2['matematicas'];?></div>
<div id="apDiv40"><?php echo $filas2['biologia'];?></div>
<div id="apDiv41"><?php echo $filas2['geografia'];?></div>
<div id="apDiv42"><?php echo $filas2['educacion_fisica'];?></div>
<div id="apDiv43"><?php echo $filas2['tecnologia'];?></div>
<div id="apDiv44"><?php echo $filas2['artes'];?></div>
<div id="apDiv45"><?php echo $filas3['esp'];?></div>
<div id="apDiv46"><?php echo $filas3['ingles'];?></div>
<div id="apDiv47"><?php echo $filas3['matematicas'];?></div>
<div id="apDiv48"><?php echo $filas3['biologia'];?></div>
<div id="apDiv49"><?php echo $filas3['geografia'];?></div>
<div id="apDiv50"><?php echo $filas3['educacion_fisica'];?></div>
<div id="apDiv51"><?php echo $filas3['tecnologia'];?></div>
<div id="apDiv52"><?php echo $filas3['artes'];?></div>
<div id="apDiv53"><?php echo $filas4['esp'];?></div>
<div id="apDiv54"><?php echo $filas4['ingles'];?></div>
<div id="apDiv55"><?php echo $filas4['matematicas'];?></div>
<div id="apDiv56"><?php echo $filas4['biologia'];?></div>
<div id="apDiv57"><?php echo $filas4['geografia'];?></div>
<div id="apDiv58"><?php echo $filas4['educacion_fisica'];?></div>
<div id="apDiv59"><?php echo $filas4['tecnologia'];?></div>
<div id="apDiv60"><?php echo $filas4['artes'];?></div>
<div id="apDiv61"><?php echo $filas5['esp'];?></div>
<div id="apDiv62"><?php echo $filas5['ingles'];?></div>
<div id="apDiv63"><?php echo $filas5['matematicas'];?></div>
<div id="apDiv64"><?php echo $filas5['biologia'];?></div>
<div id="apDiv65"><?php echo $filas5['geografia'];?></div>
<div id="apDiv66"><?php echo $filas5['educacion_fisica'];?></div>
<div id="apDiv67"><?php echo $filas5['tecnologia'];?></div>
<div id="apDiv68"><?php echo $filas5['artes'];?></div>
...
<div id="apDiv88"><a href="boletas.php"><img id="imprimir" src="../img/regresar.png" width="90" height="63" /></a></div>
</body>
</html>