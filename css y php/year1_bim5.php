...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO year1_bim5 (bimestre, matricula_alumno, nombre_alumno, esp1, ingles1, matematicas1, ciencias1_biologia, geografia_mexico, educacion_fisica1, tecnologia1, artes1, asignatura_estatal, tutoria, tic, vida_saludable) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
<div  class="cabezal">
  ...
  <table width="454" border="1" align="center">
    <tr>
      <td>INSERCION DE CALIFICACIONES PROMER AÑO BIMESTRE 5</td>
    </tr>
  </table>
