...
$sql1 = "SELECT * FROM proyecto.year1_bim3 WHERE matricula_alumno = ".$matricula_alumno." and bimestre = ".$bimestre."";
$resultado1 = mysql_query($sql1,$idc) or die(mysql_error());
$filas1 = mysql_fetch_assoc($resultado1);
$a=$filas1['esp3'];
$b=$filas1['matematicas3'];
$c=$filas1['quimica'];
$d=$filas1['historia2'];
$e=$filas1['educacion_fisica3'];
$f=$filas1['tecnologia3'];
$g=$filas1['artes3'];
$h=$filas1['ingles3'];
...
$sql2 = "SELECT * FROM proyecto.year1_bim3 WHERE matricula_alumno = ".$matricula_alumno." and bimestre = ".$bimestre2."";
$resultado2 = mysql_query($sql2,$idc) or die(mysql_error());
$filas2 = mysql_fetch_assoc($resultado2);
$a2=$filas2['esp3'];
$b2=$filas2['matematicas3'];
$c2=$filas2['quimica'];
$d2=$filas2['historia2'];
$e2=$filas2['educacion_fisica3'];
$f2=$filas2['tecnologia3'];
$g2=$filas2['artes3'];
$h2=$filas2['ingles3'];
...
$sql3 = "SELECT * FROM proyecto.year1_bim3 WHERE matricula_alumno = ".$matricula_alumno." and bimestre = ".$bimestre3."";
$resultado3 = mysql_query($sql3,$idc) or die(mysql_error());
$filas3 = mysql_fetch_assoc($resultado3);
$a3=$filas3['esp3'];
$b3=$filas3['matematicas3'];
$c3=$filas3['quimica'];
$d3=$filas3['historia2'];
$e3=$filas3['educacion_fisica3'];
$f3=$filas3['tecnologia3'];
$g3=$filas3['artes3'];
$h3=$filas3['ingles3'];
...
$sql4 = "SELECT * FROM proyecto.year1_bim3 WHERE matricula_alumno = ".$matricula_alumno." and bimestre = ".$bimestre4."";
$resultado4 = mysql_query($sql4,$idc) or die(mysql_error());
$filas4 = mysql_fetch_assoc($resultado4);
$a4=$filas4['esp3'];
$b4=$filas4['matematicas3'];
$c4=$filas4['quimica'];
$d4=$filas4['historia2'];
$e4=$filas4['educacion_fisica3'];
$f4=$filas4['tecnologia3'];
$g4=$filas4['artes3'];
$h4=$filas4['ingles3'];
...
$sql5 = "SELECT * FROM proyecto.year1_bim3 WHERE matricula_alumno = ".$matricula_alumno." and bimestre = ".$bimestre5."";
$resultado5 = mysql_query($sql5,$idc) or die(mysql_error());
$filas5 = mysql_fetch_assoc($resultado5);
$a5=$filas5['esp3'];
$b5=$filas5['matematicas3'];
$c5=$filas5['quimica'];
$d5=$filas5['historia2'];
$e5=$filas5['educacion_fisica3'];
$f5=$filas5['tecnologia3'];
$g5=$filas5['artes3'];
$h5=$filas5['ingles3'];
...
<div id="apDiv4">3er GRADO DE EDUCACIÓN SECUNDARIA</div>
...
<div id="apDiv26">_____________________________________</div>
<div id="apDiv27">
  <h4>NOMBRE Y FIRMA DEL (DE LA) DIRECTOR(A)</h4>
</div>
<div id="apDiv28"><?php echo $filas1['esp3'];?>
</div>
<div id="apDiv29"><?php echo $filas1['ingles3'];?></div>
<div id="apDiv30"><?php echo $filas1['matematicas3'];?></div>
<div id="apDiv31"><?php echo $filas1['quimica'];?></div>
<div id="apDiv32"><?php echo $filas1['historia2'];?></div>
<div id="apDiv33"><?php echo $promedio;?></div>
<div id="apDiv34"><?php echo $filas1['educacion_fisica3'];?></div>
<div id="apDiv35"><?php echo $filas1['tecnologia3'];?></div>
<div id="apDiv36"><?php echo $filas1['artes3'];?></div>
<div id="apDiv37"><?php echo $filas2['esp3'];?></div>
<div id="apDiv38"><?php echo $filas2['ingles3'];?></div>
<div id="apDiv39"><?php echo $filas2['matematicas3'];?></div>
<div id="apDiv40"><?php echo $filas2['quimica'];?></div>
<div id="apDiv41"><?php echo $filas2['historia2'];?></div>
<div id="apDiv42"><?php echo $filas2['educacion_fisica3'];?></div>
<div id="apDiv43"><?php echo $filas2['tecnologia3'];?></div>
<div id="apDiv44"><?php echo $filas2['artes3'];?></div>
<div id="apDiv45"><?php echo $filas3['esp3'];?></div>
<div id="apDiv46"><?php echo $filas3['ingles3'];?></div>
<div id="apDiv47"><?php echo $filas3['matematicas3'];?></div>
<div id="apDiv48"><?php echo $filas3['quimica'];?></div>
<div id="apDiv49"><?php echo $filas3['historia2'];?></div>
<div id="apDiv50"><?php echo $filas3['educacion_fisica3'];?></div>
<div id="apDiv51"><?php echo $filas3['tecnologia3'];?></div>
<div id="apDiv52"><?php echo $filas3['artes3'];?></div>
<div id="apDiv53"><?php echo $filas4['esp3'];?></div>
<div id="apDiv54"><?php echo $filas4['ingles3'];?></div>
<div id="apDiv55"><?php echo $filas4['matematicas3'];?></div>
<div id="apDiv56"><?php echo $filas4['quimica'];?></div>
<div id="apDiv57"><?php echo $filas4['historia2'];?></div>
<div id="apDiv58"><?php echo $filas4['educacion_fisica3'];?></div>
<div id="apDiv59"><?php echo $filas4['tecnologia3'];?></div>
<div id="apDiv60"><?php echo $filas4['artes3'];?></div>
<div id="apDiv61"><?php echo $filas5['esp3'];?></div>
<div id="apDiv62"><?php echo $filas5['ingles3'];?></div>
<div id="apDiv63"><?php echo $filas5['matematicas3'];?></div>
<div id="apDiv64"><?php echo $filas5['quimica'];?></div>
<div id="apDiv65"><?php echo $filas5['historia2'];?></div>
<div id="apDiv66"><?php echo $filas5['educacion_fisica3'];?></div>
<div id="apDiv67"><?php echo $filas5['tecnologia3'];?></div>
<div id="apDiv68"><?php echo $filas5['artes3'];?></div>
...
<div id="apDiv85">___________________________________</div>
<div id="apDiv86">
  <h5>NOMBRE Y FIRMA DEL (DE LA) PROFESOR(A)</h5>
</div>
<div id="apDiv87"><?php echo $name." ".$ap." ".$am ; ?> </div>
<div id="apDiv88"><table>
...
<div id="apDiv89"><a href="boletas.php"><img  id="imprimir" src="../img/regresar.png" width="135" height="95" /></a></div>
</body>
</html>