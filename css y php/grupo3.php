  ...
  <table width="1109" height="52" border="1" align="center">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><a href="bimestre3.php?grado=<?php echo $_GET['grado'] ?>&bimestre=1&grupo=<?php echo $_GET['grupo'] ?>&matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ASIG</a></td>
        <td><a href="bimestre3.php?grado=<?php echo $_GET['grado'] ?>&bimestre=2&grupo=<?php echo $_GET['grupo'] ?>&matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ASIG</a></td>
        <td><a href="bimestre3.php?grado=<?php echo $_GET['grado'] ?>&bimestre=3&grupo=<?php echo $_GET['grupo'] ?>&matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ASIG</a></td>
        <td><a href="bimestre3.php?grado=<?php echo $_GET['grado'] ?>&bimestre=4&grupo=<?php echo $_GET['grupo'] ?>&matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ASIG</a></td>
        <td><a href="bimestre3.php?grado=<?php echo $_GET['grado'] ?>&bimestre=5&grupo=<?php echo $_GET['grupo'] ?>&matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ASIG</a></td>
      </tr>
      <?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
  </table>
  <br />
<?php echo $totalRows_Recordset1 ?> Registros Total </div>
<div id="apDiv4">ASIGNAR CALIFICACIONES A LOS ALUMNOS DEL TERCER GRADO</div>
<div id="apDiv5"><a href="tercero.php"><img src="../img/regresar.png" width="56" height="55" /></a></div>
<div  class="cabezal">
