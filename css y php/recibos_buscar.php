...
<body>
<div id="apDiv1">
 <table width="391" height="58">
      <form action='recibo_consulta.php' method='post' name="form_tecnicos" id="form_tecnicos" onsubmit="return revisar_tecnicos()">
        <tr>
          <td width="122" height="24" class="color-4"><span class="Estilo14">Matricula:</span></td>
          <td width="257"><input name="matricula" type='text' value='' id="cuota"  placeholder="MATRICULA" class="let"  autocomplete="off" onkeypress="return soloNumeros(event);"/>          </td>
        </tr>
...
<div id="apDiv2">LLENE LOS SIGUIENTES CAMPOS PARA BUSCAR SU RECIBO</div>
<div id="apDiv3">
  <form id="form1" name="form1" method="post" action="">
    <p>GRADO: 
      <label for="grado"></label>
    <input type="text" name="grado" id="grado"  placeholder="GRADO" class="let"  autocomplete="off" required onkeypress="return soloNumeros(event);"/>
    </p>
    <p>GRUPO:
      <label for="grupo"></label>
      <input type="text" name="grupo" id="grupo"  placeholder="GRUPO" class="let"  autocomplete="off" required onkeypress="return sololetras(event);"/>
    </p>
    <p>
