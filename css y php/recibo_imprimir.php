...
$sql = ("SELECT * FROM proyecto.tutor WHERE matricula_tutor='".$matricula."'");
$resultado = mysql_query($sql,$idc) or die(mysql_error());
$filas = mysql_fetch_assoc($resultado);

$nombre= $filas['nombre'];
$am= $filas['apellido_materno'];
$ap= $filas['apellido_paterno'];
$fecha=date("d-m-Y");


$sql1 = "INSERT INTO proyecto.recibos (id_recibo, matricula, nombre, ap, am, concepto, cuota, fecha) VALUES (null, '$matricula','$nombre','$ap','$am','$concepto','$cuota','$fecha')";
...
<div id="apDiv87"><?php echo $filas['apellido_paterno']; ?></div>
<div id="apDiv88"><?php echo $filas['apellido_materno']; ?></div>
