...
MATRICULA:
    ...
    <input type="text" name="buscar" id="buscar" placeholder="MATRICULA" autocomplete="on" class="te" required>
    <input type="submit" name="button" id="button" value="Enviar">
  </form>
</div>
<div id="apDiv13">
 <form name="form2" method="post" action="update_tutor.php">
  <table width="752" height="165" border="0" align="center">
    ...
    <tr>
      <td><label for="textfield18"></label></td>
      <td><label for="textfield18"></label></td>
      <td><label for="textfield18"></label></td>
    </tr>
    <tr>
