...
<div  class="cabezal">
  ...
  <table width="395" border="1" align="center">
    <tr>
      <td align="center">ELIMINACION  DE LOS PROFESORES </td>
    </tr>
  </table>
  <p>&nbsp;</p>
...
<form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  ...
  <p>&nbsp;</p>
  <form name="form2" method="POST" action="eliminar_profe_datos.php">
  <table width="610" border="1" align="center">
    ...
    <tr>
      <td colspan="4" align="center"><input type="submit" name="button" id="button" value="ELIMINAR" /></td>
    </tr>
  </table>
