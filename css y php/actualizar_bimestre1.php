...
mysql_select_db($database_proyecto, $proyecto);
$query_Recordset2 = sprintf("SELECT * FROM year1_bim1 WHERE year1_bim1.bimestre=%s AND year1_bim1.grupo=%s AND year1_bim1.matricula_alumno=%s", GetSQLValueString($var1_Recordset2, "int"),GetSQLValueString($var2_Recordset2, "text"),GetSQLValueString($var3_Recordset2, "int"));
...
<div id="apDiv1">
 <table width="346" height="305">
      <form action='update.php' method='post' name="form_tecnicos" id="form_tecnicos" onsubmit="return revisar_tecnicos()">
        <tr>
        ...
        <tr>
          ...
          <td width="220"><input name="esp" type='text' value='<?php echo $row_Recordset2['esp']; ?>' size="5" id="esp" />          </td>
        </tr>

        <tr>
          <td class="color-4"><span class="Estilo14">Ingles:</span></td>
          <td><input name="ingles" type='text' value='<?php echo $row_Recordset2['ingles']; ?>' size="5" id="ingles" /></td>
        </tr>
		 <tr>
          <td class="color-4"><span class="Estilo14">Matematucas:</span></td>
          <td><input name="matematicas" type='text' id="matematicas" value='<?php echo $row_Recordset2['matematicas']; ?>' size="5" /></td>
        </tr>
        <tr>
          <td class="color-4"><span class="Estilo14">Biologia:</span></td>
          <td><input name="biologia" type='text' id="biologia" value='<?php echo $row_Recordset2['biologia']; ?>' size="5" /></td>
        </tr>

        <tr>
          <td class="color-4"><span class="Estilo14">Geografia:</span></td>
          <td><input name="geografia" type='text' id="geografia" value='<?php echo $row_Recordset2['geografia']; ?>' size="5" /></td>
        </tr>
		 <tr>
          <td height="24" class="color-4"><span class="Estilo14">Educacion Fisica:</span></td>
          <td><input name="educacion_fisica" type='text' id="educacion_fisica" value='<?php echo $row_Recordset2['educacion_fisica']; ?>' size="5" /></td>
        </tr>
        <tr>
           <td class="color-4">Tecnologia:</td>
           <td><input name="tecnologia" type='text' id="tecnologia" value='<?php echo $row_Recordset2['tecnologia']; ?>' size="5" /></td>
        </tr>
        <tr>
          <td class="color-4"><span class="Estilo14">Arte:</span></td>
          <td><input name="artes" type='text' id="artes" value='<?php echo $row_Recordset2['artes']; ?>' size="5" /></td>
        </tr>
...
<div id="apDiv2">ACTUALIZAR  CALIFICACIONES</div>
<div id="apDiv4"><a href="javascript:window.history.back();"><img src="../img/regresar.png" width="54" height="48" /></a></div>
<div  class="cabezal">
