  ...
  <table width="1109" height="52" border="1" align="center">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><a href="actualizar_bimestre1.php?grado=<?php echo $_GET['grado'] ?>&amp;bimestre=1&amp;grupo=<?php echo $_GET['grupo'] ?>&amp;matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ACTU</a></td>
        <td><a href="actualizar_bimestre1.php?grado=<?php echo $_GET['grado'] ?>&amp;bimestre=2&amp;grupo=<?php echo $_GET['grupo'] ?>&amp;matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ACTU</a></td>
        <td><a href="actualizar_bimestre1.php?grado=<?php echo $_GET['grado'] ?>&amp;bimestre=3&amp;grupo=<?php echo $_GET['grupo'] ?>&amp;matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ACTU</a></td>
        <td><a href="actualizar_bimestre1.php?grado=<?php echo $_GET['grado'] ?>&amp;bimestre=4&amp;grupo=<?php echo $_GET['grupo'] ?>&amp;matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ACTU</a></td>
        <td><a href="actualizar_bimestre1.php?grado=<?php echo $_GET['grado'] ?>&amp;bimestre=5&amp;grupo=<?php echo $_GET['grupo'] ?>&amp;matricula_alumno=<?php echo $row_Recordset1['matricula_alumno']; ?>">ACTU</a></td>
      </tr>
      <?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
  </table>
  <br />
<?php echo $totalRows_Recordset1 ?> Registros Total </div>
<div id="apDiv4">ACTUALIZACION DE ALUMNOS DE PRIMER GRADO</div>
<div id="apDiv5"><a href="actualiza_primero.php"><img src="../img/regresar.png" width="60" height="56" /></a></div>
<div  class="cabezal">
